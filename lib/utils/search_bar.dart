...
class SearchBar<T> extends StatefulWidget {
  ...
  SearchBar({
    ...
    this.header,
    this.placeHolder,
    this.icon = const Icon(Icons.search, size: 23),
    this.hintText = "a",
    this.hintStyle = const TextStyle(color: Color.fromRGBO(142, 142, 147, 1)),
    this.iconActiveColor = const Color.fromRGBO(142, 142, 147, 1),
              ...
              children: <Widget>[
                Flexible(
                  child: AnimatedContainer(
                    ...
                    child: Padding(
                      padding: widget.searchBarStyle.padding.subtract(EdgeInsets.only(top: 3)),
                      child: Theme(
                        child: TextField(
